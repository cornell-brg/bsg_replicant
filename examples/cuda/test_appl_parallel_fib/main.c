...
int kernel_appl_parallel_fib (int argc, char **argv) {
        int rc;
        ...
        ******************************************************************************************************************/
        ...
        hb_mc_device_foreach_pod_id(&device, pod)
        {
                 ...
                 ******************************************************************************************************************/
                BSG_CUDA_CALL(hb_mc_kernel_enqueue (&device, grid_dim, tg_dim, "kernel_appl_parallel_fib", 3, cuda_argv));
...
declare_program_main("test_appl_parallel_fib", kernel_appl_parallel_fib);
