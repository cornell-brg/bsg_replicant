...
#else
  inline bool srcTarg( const uintE& src, const uintE& target,
                       const intE& weight, const uintT& edgeNumber )
  {
    if ( vs.isIn( target ) ) {
...
struct sparseT {
  ...
  F     f;
  G     g;
  sparseT( F& _f, G& _g, uintT vP, uintT oP )
      : f( _f ), g( _g ), v( vP ), o( oP )
  {
  }
#ifndef WEIGHTED
...
struct sparseTCount {
  ...
  size_t& ct;
  F       f;
  sparseTCount( F& _f, uintT vP, size_t& _ct )
      : f( _f ), v( vP ), ct( _ct )
  {
  }
#ifndef WEIGHTED
...
struct sparseTE {
  ...
  F     f;
  G     g;
  sparseTE( F& _f, G& _g, uintT vP, uintT oP )
      : f( _f ), g( _g ), v( vP ), o( oP )
  {
  }
#ifndef WEIGHTED
...
inline void decodeInNghBreakEarly( V* v, long i, VS& vertexSubset, F& f,
                                   G& g, bool parallel = 0 )
{
  uintE  d      = v->getInDegree();
  uchar* nghArr = v->getInNeighbors();
#ifdef WEIGHTED
  decodeWgh( denseT<F, G, VS>( f, g, vertexSubset ), nghArr, i,
             v->getInDegree() );
#else
  decode( denseT<F, G, VS>( f, g, vertexSubset ), nghArr, i,
          v->getInDegree() );
#endif
}
...
inline size_t decodeOutNghSparseSeq( V* v, long i, uintT o, F& f, G& g )
{
  ...
  size_t k      = 0;
#ifdef WEIGHTED
  decodeWgh( sparseTSeq<F, G>( f, g, i, o, k ), nghArr, i,
             v->getOutDegree(), false );
#else
  decode( sparseTSeq<F, G>( f, g, i, o, k ), nghArr, i, v->getOutDegree(),
          false );
#endif
  return k;
}
...
inline size_t countOutNgh( V* v, long i, F& f )
{
  ...
  size_t ct     = 0;
#ifdef WEIGHTED
  decodeWgh( sparseTCount<F>( f, i, ct ), nghArr, i, v->getOutDegree(),
             false );
#else
  decode( sparseTCount<F>( f, i, ct ), nghArr, i, v->getOutDegree(),
          false );
#endif
  return ct;
}
...
inline void copyOutNgh( V* v, long i, uintT o, F& f, G& g )
{
  uchar* nghArr = v->getOutNeighbors();
#ifdef WEIGHTED
  decodeWgh( sparseTE<E, F, G>( f, g, i, o ), nghArr, i,
             v->getOutDegree() );
#else
...
// this version, which decodes, filters, and then recompresses is compared
// to the version in byte.h which decodes and recompresses in one pass.
                          ...
                          uintE* tmp2 )
{
  ...
  size_t new_deg =
      pbbs::filterf( tmp1, tmp2, original_deg,
...
struct compressedSymmetricVertex {
  ...
  intT         getInNeighbor( intT j ) const { return -1; } // should not be
                                                    // called
  ...
  inline void decodeInNghBreakEarly( long i, VS& vertexSubset, F& f, G& g,
                                     bool parallel = 0 )
  {
    decode_compressed::decodeInNghBreakEarly<compressedSymmetricVertex, F,
                                             G, VS>(
        this, i, vertexSubset, f, g, parallel );
  }

  template <class F, class G>
  inline void decodeOutNgh( long i, F& f, G& g )
  {
    decode_compressed::decodeOutNgh<compressedSymmetricVertex, F, G>(
        this, i, f, g );
  }
  ...
  {
    decode_compressed::decodeOutNghSparse<compressedSymmetricVertex, F,
                                          G>( this, i, o, f, g );
  }
  ...
  {
    return decode_compressed::decodeOutNghSparseSeq<
        compressedSymmetricVertex, F, G>( this, i, o, f, g );
  }

  template <class E, class F, class G>
  inline void copyOutNgh( long i, uintT o, F& f, G& g )
  {
    decode_compressed::copyOutNgh<compressedSymmetricVertex, E, F, G>(
        this, i, o, f, g );
  }
  ...
  {
    return decode_compressed::countOutNgh<compressedSymmetricVertex, F>(
        this, i, f );
  }
...
struct compressedAsymmetricVertex {
  ...
  inline void decodeInNghBreakEarly( long i, VS& vertexSubset, F& f, G& g,
                                     bool parallel = 0 )
  {
    decode_compressed::decodeInNghBreakEarly<compressedAsymmetricVertex,
                                             F, G, VS>(
        this, i, vertexSubset, f, g, parallel );
  }
  ...
  inline void decodeOutNgh( long i, F& f, G& g )
  {
    decode_compressed::decodeOutNgh<compressedAsymmetricVertex, F, G>(
        this, i, f, g );
  }
  ...
  inline void decodeOutNghSparse( long i, uintT o, F& f, G& g )
  {
    decode_compressed::decodeOutNghSparse<compressedAsymmetricVertex, F,
                                          G>( this, i, o, f, g );
  }
  ...
  {
    return decode_compressed::decodeOutNghSparseSeq<
        compressedAsymmetricVertex, F, G>( this, i, o, f, g );
  }

  template <class E, class F, class G>
  inline void copyOutNgh( long i, uintT o, F& f, G& g )
  {
    decode_compressed::copyOutNgh<compressedAsymmetricVertex, E, F, G>(
        this, i, o, f, g );
  }
  ...
  inline size_t countOutNgh( long i, F& f )
  {
    return decode_compressed::countOutNgh<compressedAsymmetricVertex, F>(
        this, i, f );
  }
