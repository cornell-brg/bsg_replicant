...
int kernel_fib (int argc, char **argv) {
        int rc;
        ...
        ******************************************************************************************************************/
        ...
        hb_mc_device_foreach_pod_id(&device, pod)
        {
                 ...
                 ******************************************************************************************************************/
                BSG_CUDA_CALL(hb_mc_kernel_enqueue (&device, grid_dim, tg_dim, "kernel_fib", 1, cuda_argv));
...
declare_program_main("test_fib", kernel_fib);
